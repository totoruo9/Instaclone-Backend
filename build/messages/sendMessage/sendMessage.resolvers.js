                ...
                return __generator(this, function (_c) {
                    switch (_c.label) {
                        ...
                        case 3:
                            ...
                            return [4 /*yield*/, client.room.findUnique({
                                    where: {
                                        id: roomId
                                    },
                                    select: {
                        ...
                        case 6:
                            newMessage = _c.sent();
                            pubsub_1.default.publish(constants_1.NEW_MESSAGE, {
                                roomUpdates: __assign({}, newMessage)
                            });
                            return [2 /*return*/, {
                                    ok: true,
                                }];
...
exports.default = SendMessageResolvers;
