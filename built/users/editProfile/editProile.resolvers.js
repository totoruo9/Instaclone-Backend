...
var EditProfileResolvers = {
    Upload: graphql_upload_1.GraphQLUpload,
    Mutation: {
        editProfile: user_utils_1.protectedResolver(function (_, _a, _b) {
                ...
                return __generator(this, function (_c) {
                    switch (_c.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, shared_utils_1.uploadToS3(avatar, loggedInUser.id, "avatars")];
                        case 1:
                            avatarUrl = _c.sent();
                            _c.label = 2;
                        case 2:
                        ...
                        case 4:
                            ...
                            return [4 /*yield*/, client.user.update({
                                    ...
                                    data: __assign(__assign({ firstName: firstName, lastName: lastName, email: email, username: username, bio: bio }, (uglyPassword && { password: uglyPassword })), (avatarUrl && { avatar: avatarUrl }))
                                })];
                        case 5:
                            updatedUser = _c.sent();
                            if (updatedUser.id) {
...
exports.default = EditProfileResolvers;
